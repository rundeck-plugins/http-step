    ...
    public Description getDescription() {
        return DescriptionBuilder.builder()
                ...
                .property(PropertyBuilder.builder()
                        ...
                        .description("Set if you want to check response code(s).")
                        .defaultValue("false")
                ...
                .property(PropertyBuilder.builder()
                        .string("responseCode")
                        .title("Response Code")
                        .description("Expected HTTP response code(s). Use single code (e.g. 200), multiple (e.g. 200,204), ranges (e.g. 200-206), or patterns like 2xx.")
                        .required(false)
                        .renderingOption(StringRenderingConstants.GROUP_NAME,"Check Response")
                        .build())
                .property(PropertyBuilder.builder()
                        .booleanType("failOnHttpError")
                        .title("Fail on HTTP Error?")
                        .description("If enabled, any HTTP response with status code 400 or above (client/server error) will fail the step.")
                        .defaultValue("false")
                        .renderingOption(StringRenderingConstants.GROUP_NAME, "Check Response")
                        .build())
                .property(PropertyBuilder.builder()
